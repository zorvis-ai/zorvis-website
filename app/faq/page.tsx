...
const FAQS: Faq[] = [
  ...
  // ─── PRODUCT ───
  {
    id: "ai-interview",
    category: "product",
    question: "What's the AI Interview feature, and is it real?",
    shortAnswer:
      "A 5-minute AI-conducted phone call to top scorers. 4-5 standardized questions in the candidate's preferred language (English, Hindi, Tamil, Telugu, Marathi, Bengali, Kannada, Arabic). Recorded with consent, transcribed, scored. Beta launching October 2026. Included in every paid plan, no per-call fees.",
    fullAnswer: [
      "It's a 5-minute AI-conducted phone call to top-scoring candidates. The AI calls the candidate on the phone number from their application, plays a clear recording disclosure ('This call will be recorded for assessment'), then asks 4-5 standardized questions in the candidate's preferred language. Recording, transcript, and AI scoring are delivered to your HR dashboard before you spend a minute on the candidate yourself.",
      "Eight languages supported at launch: English, Hindi, Tamil, Telugu, Marathi, Bengali, Kannada, and Arabic — plus Hinglish code-switching, which is how most BPO and metro hiring conversations actually happen. Questions are role-specific: BPO uses voice quality + shift availability + customer-handling scenarios; blue-collar uses reliability + literacy + situational judgment.",
      "We're explicitly not replacing the human interview. This is the first-round screen that happens before HR's calendar gets touched. After the AI call, the top 10-15% surface in your dashboard with full transcripts and AI scoring; the rest are filtered out. HR's time goes to people worth meeting.",
      "Currently in limited beta with design partners (October 2026 launch). Included in every plan with monthly quotas: 0 interviews on Free, 50 on Starter, 200 on Growth, 1,000 on Scale. Overage billed at ₹49/₹39/₹29 per interview depending on plan. No per-call markup, no setup fees. DPDP-compliant: candidate consent captured before recording, 30-day retention, then auto-deletion. Email founder@zorvis.ai if you'd like to be a design partner.",
    ],
  },
  {
    id: "language",
